...
Planned sensitivity analyses across alternative ventilatory and hemodynamic specifications were not available in the current analysis package and should be completed before any robustness claim is made. These analyses should either be completed before submission or removed from the manuscript and supplement.
