...
| --- | --- | --- | --- |
| eTable 1/2. Baseline and intraoperative characteristics | HPC `results/manuscript_tables/table1_2_co2_rso2.xlsx`, `available_columns.csv`, `flow_counts.csv`, `long.csv`, and `wide.csv` | generated remotely, pending local pull | Generated on `g24`; see `CO2_TABLE1_2_HPC_RUN_LOG.md` |
...
| --- | --- | --- |
| Main Table 1 | remote `table1_2_co2_rso2.xlsx` | Use concise patient/cohort characteristics in main manuscript; move full long table to supplement |
...
- Pull the generated Table 1/2 files from HPC when SSH stabilizes.
